...
public class ChampionPresentTests
{
    ...
    public void 조건과_액션에_맞는_특성_텍스트_생성()
    {
        ...
        // 편의 함수
        string GetTraitText(TraitConditionType conditionType, int thershold) => sut.CreateViewModel(default, new TraitUI_Data(TraitType.DefenseChanger, Side.Opponent, TargetRange.All, -10, conditionType, thershold)).Trait;
