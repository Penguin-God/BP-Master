...
public class ValueCalcualateTests
{
    ...
    ChampionValueCalculator CreateSut(BonusCalculator bonusCalculator, int masteryLevel = 0)
    {
        ...
        return new ChampionValueCalculator(statCalculator, new ChampionValueApplier(previewer, CreateMasteryApplier(new ChampionMastery(CHAMP_ID, masteryLevel))), bonus, Team.Blue, originSlots);
    }
